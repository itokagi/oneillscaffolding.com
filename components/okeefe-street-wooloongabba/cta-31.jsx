  ...
  return (
    <section className="relative overflow-hidden px-[5%] py-24 md:py-32 scheme-4">
      <div className="absolute inset-0">
        <img src="https://images.unsplash.com/photo-1486325212027-8081e485255e?auto=format&fit=crop&w=1920&q=80" alt="" className="size-full object-cover opacity-15" />
      ...
      <div className="container relative z-10 mx-auto max-w-2xl text-center">
        ...
        <h2 className="mb-5 text-h2 font-bold text-white md:mb-6">Urban Site Expertise</h2>
        <p className="mb-10 text-white/70 text-medium">Tight inner-city sites are where OSG excels — precise, compliant, on schedule.</p>
