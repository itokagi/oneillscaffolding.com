    ...
    <section className="px-[5%] py-16 md:py-24 lg:py-28 scheme-1">
      <div className="container">
        <div className="mx-auto max-w-2xl text-center">
          <BrandName name="ADCO Constructions" className="mb-8 text-sm font-bold tracking-widest uppercase" />
          <p className="mb-3 text-4xl font-bold leading-none text-punch">&ldquo;</p>
          <h5 className="mb-10 text-h5 font-bold">
            Every trade that followed them had access ready and waiting. That&apos;s
            rare — and it kept our program on track from Level 1 through to roof.
          </h5>
          <div className="flex flex-col items-center gap-2">
            ...
            <p className="text-sm text-neutral-dark">Project Manager, Developer</p>
