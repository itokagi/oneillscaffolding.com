  ...
  return (
    <section className="relative overflow-hidden px-[5%] py-24 md:py-32 scheme-4">
      ...
      <div className="container relative z-10 mx-auto max-w-2xl text-center">
        ...
        <h2 className="mb-5 text-h2 font-bold text-white md:mb-6">Complex Site? Let OSG Handle It</h2>
        <p className="mb-10 text-white/70 text-medium">Specialist scaffolding for medical, retail, and mixed-use developments.</p>
