  ...
  return (
    <section className="relative overflow-hidden px-[5%] py-24 md:py-32 scheme-4">
      <div className="absolute inset-0">
        <img src="https://images.unsplash.com/photo-1524492412937-b28074a5d7da?auto=format&fit=crop&w=1920&q=80" alt="" className="size-full object-cover opacity-15" />
      ...
      <div className="container relative z-10 mx-auto max-w-2xl text-center">
        ...
        <h2 className="mb-5 text-h2 font-bold text-white md:mb-6">Join Hundreds of Satisfied Clients</h2>
        <p className="mb-10 text-white/70 text-medium">See why builders across Queensland choose OSG for every project type.</p>
