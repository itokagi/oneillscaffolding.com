...
function TabsTrigger({ children, className, onClick, ...props }) {
    return (<TabsPrimitive.Trigger data-slot="tabs-trigger" className={cn("inline-flex items-center justify-center rounded-button px-6 py-2.5 whitespace-nowrap focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50", "border border-scheme-border data-[state=active]:bg-transparent data-[state=inactive]:border-transparent", className)} {...props}>
      {children}
